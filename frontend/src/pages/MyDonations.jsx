...
import { FiHeart, FiCalendar, FiAward, FiTrendingUp, FiActivity, FiArrowRight } from 'react-icons/fi';
                ...
                <div className="flex flex-col md:flex-row items-center gap-6">
                  ...
                  <div className="flex-1 w-full text-center md:text-left">
                    <div className="flex flex-col md:flex-row md:items-start justify-between">
                        ...
                        {/* Amount Section */}
                        <div className="mt-4 md:mt-0 text-center md:text-right pl-0 md:pl-6 border-t md:border-t-0 md:border-l border-gray-200 pt-4 md:pt-0">
